"""
Se tiene que cargar los votos obtenidos por tres candidatos a una eleccion.
En una lista cargar en la primer componente el nombre del candidato y en la segunda componente
cargar una lista con componentes de tipo tupla con el nombre de la provincia y la cantidad de votos 
obtenidos en dicha provincia.
Se deben cargar los datos por teclado, pero si se cargaran por asignacion tendria una estructura 
similar a esta:
